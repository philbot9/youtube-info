const youtubeInfo = require('./index')
...
describe('youtube-info', () => {
  ...
  it('exports a function', () => {
    expect(typeof youtubeInfo).toBe('function')
  })
  ...
  it('happy path', () => {
    ...
    return expect(youtubeInfo(videoId, opts)).resolves
      .toEqual({
        video: 'details',
        commentCount: 200
      })
  ...
  describe('opts parameter', () => {
    ...
    it('no opts', () => {
      return expect(youtubeInfo('abc123')).resolves
        .toEqual({
          commentCount: 200,
          video: 'details'
        })
    ...
    it('opts', () => {
      ...
      return expect(youtubeInfo('abc123', myOpts)).resolves
        .toEqual({
          commentCount: 200,
          video: 'details'
        })
